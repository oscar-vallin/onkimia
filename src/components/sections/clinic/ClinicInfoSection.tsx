...
import { clinicConfig, getMapsUrlBySlug, type ClinicSlug } from '@/config/clinicConfig';
...
export async function ClinicInfoSection({ clinic = 'guadalajara', first }: SectionProps) {
  ...
  // Only owns the h1 when it opens the page (no hero before it); mid-page
  // the h1 was already set by the hero and this must be h2 (one h1 per page).
      ...
      <div className="container-onkimia">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div>
            ...
            <a
              href={getMapsUrlBySlug(data.slug)}
              target="_blank"
