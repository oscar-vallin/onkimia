...
export function Header({}: HeaderProps) {
  ...
  const navLinks = getNavLinks(clinic, tNav);
            ...
            <nav className="hidden lg:flex items-center gap-8">
              {navLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className={`relative text-[1rem] font-medium transition-colors py-2 ${appearance.textColor} ${
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="hidden md:block relative">
                <button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 text-[1rem] font-medium transition-colors duration-300 cursor-pointer ${appearance.textColor} ${appearance.hoverColor}`}
                    ...
                    {CLINICS.map((c) => {
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left cursor-pointer px-4 py-2 text-[1rem] hover:bg-gray-50 transition-colors ${
              ...
              <button
                ...
                className={`flex items-center gap-1.5 px-3 py-2 text-[1rem] font-medium transition-colors duration-300 cursor-pointer ${appearance.textColor} ${appearance.hoverColor}`}
                ...
                <div className="mt-6 py-4 text-center space-y-3">
                  ...
                  {whatsappUrl && (
                    <a
                      ...
                      onClick={toggleMobileMenu}
                      className={`flex items-center justify-center gap-2 mx-auto px-6 py-3 ${appearance.mobileWhatsAppClass} font-medium rounded-full transition-colors w-full max-w-[200px] text-[1rem]`}
                    >
                      ...
                      <span className="text-[1rem]">{tCommon('scheduleAppointmentWhatsApp')}</span>
                    </a>
                  )}
                  ...
                  <button
                    type="button"
                    onClick={switchLocale}
                    className="flex items-center gap-1.5 px-4 py-2 rounded-full text-[1rem] font-medium bg-white/5 border border-white/20 text-white/60 hover:bg-white/10 hover:text-white transition-colors mx-auto"
                    aria-label={`Switch to ${otherLocale.toUpperCase()}`}
                  >
                    <Globe className="w-4 h-4" />
                    <span>{otherLocale.toUpperCase()}</span>
