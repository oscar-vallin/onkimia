  ...
  return (
    ...
    <div className="doctors-page">
      ...
      <PageHero
        ...
        topSlot={
          <a
            href={buildWhatsApp(waJoin, t('cta.message'))}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 border border-white/25 rounded-full px-3.5 py-2 sm:px-4 bg-white/[0.06] backdrop-blur-sm hover:bg-white/[0.12] hover:border-white/40 transition-colors"
          >
            <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" className="text-doctors-blue" aria-hidden="true">
            ...
            <span className="text-[11px] tracking-[0.18em] uppercase text-white/90 font-medium">{t('hero.joinButton')}</span>
          </a>
        }
        solidLeftBand
      >
