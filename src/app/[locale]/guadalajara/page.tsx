...
export async function generateMetadata({
  ...
  return buildMetadata({
    title: t('guadalajara.title'),
    description: t('guadalajara.description'),
    locale,
    pathname: '/guadalajara',
  });
}

export default async function GuadalajaraPage({
  params,
}: {
  params: Promise<{ locale: Locale }>;
}) {
  ...
  return (
    <>
      ...
      <MedicalClinicJsonLd
        ...
        url={locale === 'es' ? '/guadalajara' : '/en/guadalajara'}
      />
    </>
  );
}
