...
import { MedicalProcedureLd, FAQPageLd, BreadcrumbListJsonLd } from '@/components/seo/JsonLd';
...
export default async function CuidarePage({
  ...
  const [settings, faqs, t, tNav] = await Promise.all([
  ...
  return (
    <>
      <HeroPreload name="cuidare" />
      <BreadcrumbListJsonLd
        locale={locale}
        items={[
          { href: ROUTES.home, name: tNav('home') },
          { href: ROUTES.cuidare, name: tNav('cuidare') },
        ]}
      />
